...
class User_Permission extends \Model\Base {
    ...
    public static function _init()
    {
        ...
        static::$_table_name = \Config::get('gasauth.table_name', 'users').'_user_permissions';
        
        // model language file
        \Lang::load('model/user/permission', 'auth.model.user_permission');
    }
    
}

/* End of file permission.php */
/* Location: ./fuel/gasoline/modules/auth/classes/model/auth/user/permission.php */
