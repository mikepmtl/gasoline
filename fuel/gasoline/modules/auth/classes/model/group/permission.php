...
class Group_Permission extends \Model\Base {
    ...
    public static function _init()
    {
        ...
        // model language file
        \Lang::load('model/group/permission', 'auth.model.group_permission');
    }
    
}

/* End of file permission.php */
/* Location: ./fuel/gasoline/modules/auth/classes/model/auth/group/permission.php */
