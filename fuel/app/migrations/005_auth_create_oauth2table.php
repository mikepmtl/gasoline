...
class Auth_create_oauth2table {
    ...
    function up()
    {
        ...
        if ( in_array('Gasauth', $drivers) )
        {
            ...
            $basetable = \Config::get('gasauth.table_name', 'users');
        }
        else
        {
            $basetable = 'users';
        ...
        \DBUtil::create_table($basetable . '_sessions',
            array(
                ...
                'first_requested'   => array('type' => 'int', 'constraint' => 11, 'unsigned' => true),
                'last_updated'      => array('type' => 'int', 'constraint' => 11, 'unsigned' => true),
