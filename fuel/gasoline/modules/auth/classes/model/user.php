...
class User extends \Model\Base {
    ...
    /**
     * Default conditions that are applied if no other conditions are run on
     * a query generated by this object
     * 
     * @var array
     */
    ...
    protected static $_has_many = array(
        ...
        'userpermissions' => array(
            'key_from'          => 'id',
            'key_to'            => 'user_id',
            'model_to'          => 'Auth\\Model\\User_Permission',
            'cascade_save'      => false,
            'cascade_delete'    => true,
        ),
    );
    ...
    public static function _init()
    {
        ...
        // model language file
        \Lang::load('model/user', 'auth.model.user');
    }
...
/* Location: ./fuel/gasoline/modules/auth/classes/model/auth/user.php */
